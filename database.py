...
class Database:
    ...
    def processCrimeReport(self):
        ...
        requests = [UpdateOne({'crimeID' : crime.crimeID},
                    {'$set': {'reportDate' : crime.reportDate, 'crimeStart' : crime.crimeStart,
                    'crimeEnd' : crime.crimeEnd, 'offenses' : crime.offenses,
                    'location' : crime.location, 'disposition' : crime.disposition}}, upsert = True)
